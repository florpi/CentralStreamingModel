...
class VD: 
	...
	def read_file(self, extra):
		...
		if not extra:
			file_name = f'/cosma6/data/dp004/dc-cues1/pv_results/{self.tracer}_b{self.box:1d}.txt'
			#file_name = f'/cosma/home/dp004/dc-cues1/CentralPairwiseVels/results/{self.tracer}_b{self.box:1d}.txt'
		else:
			file_name = f'/cosma6/data/dp004/dc-cues1/pv_results/{self.tracer}_b{self.box:1d}_{extra}.txt'
...
class VD_los:
	...
	def read_file(self,extra):
		...
		if not extra:
			file_name = f'/cosma6/data/dp004/dc-cues1/pv_results/{self.tracer}_b{self.box:1d}_los.txt'
			#file_name = f'/cosma/home/dp004/dc-cues1/CentralPairwiseVels/results/{self.tracer}_b{self.box:1d}_los.txt'
		else:
			file_name = f'/cosma6/data/dp004/dc-cues1/pv_results/{self.tracer}_b{self.box:1d}_{extra}_los.txt'
			#file_name = f'/cosma/home/dp004/dc-cues1/CentralPairwiseVels/results/{self.tracer}_b{self.box:1d}_{extra}_los.txt'
